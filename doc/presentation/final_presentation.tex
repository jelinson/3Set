...
\titlegraphic{\includegraphics[width=.35\paperwidth]{img/logo.png}}

\title{3Set}
\subtitle{An iOS Game of Mixing \& Matching}
\institute{Aquincum Institute of Technology\\Harvey Mudd College}
\logo{\includegraphics[width=.15\paperwidth]{img/logo.png}}
...
\begin{figure}
\centering 
\visible<2->{\includegraphics[width=.5\paperwidth]{img/triplet.png}}
\end{figure}
